  ...
  (0, _createClass3.default)(BotML, [{
    ...
    value: function start() {
      ...
      if (_context2.default.workflows.size) {
        var workflow = new _block2.default((0, _from2.default)(_context2.default.workflows)[0][1].raw);
        ...
        switch (input) {
          ...
          case '/activators':
            ...
            _context2.default.dialogues.forEach(function (dialogue) {
              return (0, _utils.info)(dialogue.activators.join(' , '));
            });
            break;
          case '/current':
            if (currentDialogue) {
    ...
    value: function _parse(content) {
      ...
      blocks.forEach(function (block) {
        var b = new _block2.default(block);
        if (_context2.default[b.type + 's'].has(b.label)) {
          (0, _utils.warn)(b.type + ' "' + b.label + '" already set.');
        }
        _context2.default[b.type + 's'].set(b.label.toLowerCase(), b);
      });
    }
  }, {
    key: '_handleDialogue',
    value: function _handleDialogue(dialogue) {
      ...
      currentDialogue = {
        ...
        dialogue: new _block2.default(dialogue.raw) // clone
      };
