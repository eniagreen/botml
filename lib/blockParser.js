...
var Parser = _machina2.default.Fsm.extend({
    ...
    service: {
      _onEnter: function _onEnter() {
        ...
        var _line$match$slice = this.line.match(/^(\w+)\s*\(([^)]*)\)(\.[.\w[\]]+)?\s*$/i).slice(1),
            _line$match$slice2 = (0, _slicedToArray3.default)(_line$match$slice, 3),
            label = _line$match$slice2[0],
            value = _line$match$slice2[1],
            output = _line$match$slice2[2]; // eslint-disable-line no-unused-vars
  ...
  next: function next() {
    var process = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  ...
  activators: function activators() {
    var forceReloading = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
